...
<p class="tagline">I build event-driven systems, integrations, and data pipelines where data moves between services and correctness matters — Kafka-backed telemetry, bidirectional synchronization, and high-volume ETL.</p>
